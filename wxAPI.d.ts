...
interface WXUIAPI {
	...
	reLaunch(obj: { url: string } & WXCommonObj);
	...
	navigateToMiniProgram(obj: { appId: string, path?:string })
}
...
interface WXOpenAPI {
	...
	getSetting(obj: { success?: (res: { errMsg: string, code: string, [propName: string]: any }) => void, fail?: WXCommonCallback, complete?: WXCommonCallback  });
	authorize(obj: { scope:string,success?: (res: { errMsg: string, code: string, [propName: string]: any }) => void, fail?: WXCommonCallback, complete?: WXCommonCallback  });
	openSetting(obj: { success?: (res: { errMsg: string, code: string, [propName: string]: any }) => void, fail?: WXCommonCallback, complete?: WXCommonCallback  });
